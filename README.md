# Proyecto que simula un E-commerce. Adaptado a distintos dispositivos, con petición a una API de prueba para la muestra con diseño grid y flex para los productos relacionados.
